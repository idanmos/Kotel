...
extension LocalizedStringResource {
    ...
    enum InfoPlist {
        ...
        /**
         ...
         Localized string for key “NSLocationWhenInUseUsageDescription” in table “InfoPlist.xcstrings”.
         */
        static var nslocationWhenInUseUsageDescription: LocalizedStringResource {
            LocalizedStringResource("NSLocationWhenInUseUsageDescription", table: "InfoPlist", bundle: resourceBundleDescription)
        }

        /**
         Supports Live Activities
         
         Localized string for key “NSSupportsLiveActivities” in table “InfoPlist.xcstrings”.
         */
        static var nssupportsLiveActivities: LocalizedStringResource {
            LocalizedStringResource("NSSupportsLiveActivities", table: "InfoPlist", bundle: resourceBundleDescription)
        }
    }
}